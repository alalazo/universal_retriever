...
namespace universal_retriever
{
    ...
    class HandlerInfo
    {
      public:
         ...
         */
        HandlerInfo(const std::string& name, const std::string& version, const std::string& method)
         ...
         */
        std::string serialization_method() const { return m_method; }
    ...
    inline bool operator==(const HandlerInfo& a, const HandlerInfo& b)
    {
        if (a.name() == b.name() && a.version() == b.version() && a.serialization_method() == b.serialization_method())
        {
            return true;
        }
        return false;
